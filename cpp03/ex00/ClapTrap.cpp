...
/*   Updated: 2023/01/23 14:19:29 by sguilher         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ClapTrap.hpp"

int ClapTrap::_generic_robots = 0;

ClapTrap::ClapTrap(void): _hitPoints(10), 
						_energyPoints(10), 
						_attackDamage(0) {
	++ClapTrap::_generic_robots;
	std::string index;
	index.push_back(ClapTrap::_generic_robots + 48);
...
ClapTrap::~ClapTrap(void) {
	std::cout << ORANGE << this->getName() << " destroyed" << RESET << std::endl;
}
...
ClapTrap& ClapTrap::operator=(ClapTrap const& ct) {
	...
	std::cout << YELLOW << "ClapTrap " << this->getName() << " copied" << RESET << std::endl;
	return (*this);
}
...
void ClapTrap::takeDamage(unsigned int amount) {
	...
	std::cout << RED << "ClapTrap " << this->getName() << " attacked with " 
...
void ClapTrap::beRepaired(unsigned int amount) {
	...
	if (hitPoints > 0 && energyPoints > 0) {
		...
		std::cout << GREEN << "ClapTrap " << this->getName() 
				...
				<< " hit points, resulting in a total of " << hitPoints 
