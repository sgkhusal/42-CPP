...
/*   Updated: 2023/06/11 01:46:31 by sguilher         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(void) {
	...
	testDescription("Intern try to create a shrubbery creation form");
	...
	testDescription("Intern try to create a robotomy request form");
	...
	testDescription("Intern try to create a presidential pardon form");
	...
	testDescription("Intern try to create an invalid type form");
